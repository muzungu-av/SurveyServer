 ...
 * 
 */
@WebServiceClient(name = "DailyInfo", targetNamespace = "http://web.cbr.ru/", wsdlLocation = "file:/DATA/Project/Java/TestTasks/CBR_get_currency/backend/DailyInfo.asmx.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/DATA/Project/Java/TestTasks/CBR_get_currency/backend/DailyInfo.asmx.xml");
